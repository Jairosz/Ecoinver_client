...
@Component({
  ...
  template: `
    <div id="view" class="h-full w-screen flex flex-row">
      <!-- Botón para mostrar el sidebar (visible en móviles) -->
      <button
        (click)="sidenav = true"
      ...
      <!-- Sidebar: se muestra si sidenav es true -->
      <div
        id="sidebar"
          ...
          <div id="menu" class="flex flex-col space-y-2">
            ...
            >
              ...
              >
                <path
                  fill-rule="evenodd"
                  d="M6 2a1 1 0 000 2h2a1 1 0 100-2H6z"
                  clip-rule="evenodd"
                ></path>
                <path
                  d="M2 5a2 2 0 012-2h7a2 2 0 012 2v4a2 2 0 01-2 2H9l-3 3v-3a2 2 0 00-2-2V5z"
                ></path>
              </svg>
              <span>Calendar</span>
            </a>
